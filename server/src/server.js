...
io.on('connection', (socket) => {
  ...
  // Aggiungi il gestore di riconnessione QUI, DENTRO il blocco io.on('connection')
  ...
  }); // QUESTA è la chiusura del blocco io.on('connection')
  ...
  // RIMUOVI TUTTO IL CODICE socket.on('reconnect-to-game') CHE È STATO INSERITO QUI FUORI